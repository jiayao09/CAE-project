...
This project simulates the motion pattern of turbulent flow through pipes of different diameters. The figure below shows the cross-sectional view of the pipe and the fluid direction for this project.
